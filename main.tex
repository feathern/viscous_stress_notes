...
\begin{align}
\label{eq:vectens}
b_r &=  \left(\etwid_{rr}\,m_r + \etwid_{r\theta}\,m_\theta + \etwid_{r\phi}\,m_\phi \right) =& ? \\
b_\theta &=\left(\etwid_{\theta r}\,m_r + \etwid_{\theta\theta}\,m_\theta + \etwid_{\theta\phi}\,m_\phi \right) =& ? \\  
b_\phi &=  \left(\etwid_{\phi r}\,m_r + \etwid_{\phi\theta}\,m_\theta + \etwid_{\phi\phi}\,m_\phi \right) =& ? 
\end{align}
